  ...
  return (
    <div className="min-h-screen bg-gray-800 flex flex-col">
      ...
      <div className="absolute top-4 left-4 z-10">
        <h1 className="text-2xl font-semibold text-white font-display tracking-tight">Register</h1>
      </div>

      {/* Main content area */}
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-2xl w-full max-w-6xl min-h-[600px] flex">
